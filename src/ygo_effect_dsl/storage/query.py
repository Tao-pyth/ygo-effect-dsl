...
_FIELD_SPECS: dict[str, _FieldSpec] = {
    ...
    "opening_hand_cohort": _FieldSpec("string", _SCALAR_OPERATORS),
    "profile": _FieldSpec("string", _SCALAR_OPERATORS),
    "success_predicate": _FieldSpec("string", _SCALAR_OPERATORS),
    "ranking_policy": _FieldSpec("string", _SCALAR_OPERATORS),
    "termination": _FieldSpec("string", _SCALAR_OPERATORS),
    "censor_state": _FieldSpec("string", _SCALAR_OPERATORS),
    "core_lock": _FieldSpec("string", _SCALAR_OPERATORS),
    "asset_lock": _FieldSpec("string", _SCALAR_OPERATORS),
