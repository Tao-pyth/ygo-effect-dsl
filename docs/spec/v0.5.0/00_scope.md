...
Status: Planned; parent [#133](https://github.com/Tao-pyth/ygo-effect-dsl/issues/133)
...
7. corpus/run/deck/strategy/interruption overviewとRoute drill-down UI。
8. large table virtualization、accessibility、responsive verification。
9. JSON/CSV/Parquet exportとCLI/API/UI parity。
10. 10万run/100万row規模のingest/query/UI/export benchmark。
...
- UIは運用・調査用途のため、denseでscan可能なtableとlineage中心にする。
