...
Status: Implemented and qualified locally; node-level pool/cache runtime is planned for package 0.6.0 in [#231](https://github.com/Tao-pyth/ygo-effect-dsl/issues/231)
