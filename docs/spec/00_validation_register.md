...
| `VAL-020` | GitHub Actions runtime | checkout v7、setup-python v6、upload-artifact v7へ更新しNode 24対応。self-hosted ephemeral runner v2.335.1で再検証 | `VERIFIED_LOCAL` | [#138](https://github.com/Tao-pyth/ygo-effect-dsl/issues/138), [#173](https://github.com/Tao-pyth/ygo-effect-dsl/issues/173) |
