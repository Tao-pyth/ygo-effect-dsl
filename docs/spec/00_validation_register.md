...
| `VAL-012` | 10万node・実worker性能 | 外部qualification 3 Routeで10万logical nodeを再校正。pool 1/2/4/8/16、disabled/index-only、各16 taskの480 fresh Replayを完走し、throughput/RSS/artifactとsemantic不変性を保存 | `VERIFIED_LOCAL` | [#105](https://github.com/Tao-pyth/ygo-effect-dsl/issues/105), [#128](https://github.com/Tao-pyth/ygo-effect-dsl/issues/128) |
