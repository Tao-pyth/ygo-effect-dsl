...
| `VAL-031` | deck-first desktop frontend | `desktop-workflow-v1`とpackaged local HTML/CSS/JSでdeck catalog、statistics、card detail、search/preflight、synthetic job/cancel/result、comparisonを実装。default-deny CSP、network/direct bridgeなし、keyboard command、reduced motion/high contrast、Edge DOM 4 row、1440×900/960×700 screenshotを確認。real bridge/worker、100k virtualization、WebView2 lifecycle/a11yは#244/#165/#245が未完了 | `VERIFIED_LOCAL` | [#182](https://github.com/Tao-pyth/ygo-effect-dsl/issues/182), [#184](https://github.com/Tao-pyth/ygo-effect-dsl/issues/184), [#244](https://github.com/Tao-pyth/ygo-effect-dsl/issues/244), [#165](https://github.com/Tao-pyth/ygo-effect-dsl/issues/165), [#245](https://github.com/Tao-pyth/ygo-effect-dsl/issues/245) |
