...
`0.5.0`の実装項目とlocal scale gateは2026-07-16に完了した。10万run、100万Event/Decision row、10万aggregation rowのevidenceに基づき、export hard capは100,000行へ校正した。package version更新とsource release gateは別途完了させるが、一般配布・production保証は`1.0.0`の#91/#134まで行わない。
